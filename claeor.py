...
def home_screen():
    ...
    st.write("""
        ...
        for a General Aviation business venture, comprised of a Luxury style FBO, a MRO and an aircraft Dealership, all part of a combined facility and for which franchises are to be established in order to deliver services directly in numerious regional locations. You can then view the financial statements and performance metrics based on the provided 
