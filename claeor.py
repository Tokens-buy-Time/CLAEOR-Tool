...
def financial_statements_screen():
    ...
    st.write(" ")
    st.write("Each year's Income, Balance and Cash Flow Statement use the last saved data for the particular year. The respective statements will appear directly below the saved input operational data for each particular year and will reflect the saved general assumptions as well.")
    Income_Year()
    Balance_Sheet_Year()
    Cash_Flow_Year()
