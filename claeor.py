...
def operations_data_screen():
    ...
    if i<11:
       for i, year_data in enumerate(Ops_labels):
           ...
           st.session_state["operations_data"][i,2] = st.number_input(Ops_labels, value=st.session_state["operations_data"][10*(i-1)+2])
           st.session_state["operations_data"][i,3] = st.number_input(Ops_labels, value=st.session_state["operations_data"][10*(i-1)+3])
           st.session_state["operations_data"][i,4] = st.number_input(Ops_labels, value=st.session_state["operations_data"][10*(i-1)+4])
           st.session_state["operations_data"][i,5] = st.number_input(Ops_labels, value=st.session_state["operations_data"][10*(i-1)+5])
           st.session_state["operations_data"][i,6] = st.number_input(Ops_labels, value=st.session_state["operations_data"][10*(i-1)+6])
           st.session_state["operations_data"][i,7] = st.number_input(Ops_labels, value=st.session_state["operations_data"][10*(i-1)+7])
           st.session_state["operations_data"][i,8] = st.number_input(Ops_labels, value=st.session_state["operations_data"][10*(i-1)+8])
           st.session_state["operations_data"][i,9] = st.number_input(Ops_labels, value=st.session_state["operations_data"][10*(i-1)+9])
           st.session_state["operations_data"][i,10] = st.number_input(Ops_labels, value=st.session_state["operations_data"][10*(i-1)+10])
