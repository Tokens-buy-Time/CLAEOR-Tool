...
def operations_data_screen():
    ...
    for i in range(0,90):
        for j in range(i,i+10):
            ...
            st.session_state["operations_data"][j] = st.number_input(Ops_labels, value=min, placeholder=Target_Rental_hrs)
            j=j+1
            Size_of_fleet = st.session_state["operations_data"][j]
            st.session_state["operations_data"][j] = st.number_input(Ops_labels, value=min, placeholder=Size_of_fleet)
            j=j+1
            Number_of_aircraft_sold = st.session_state["operations_data"][j]
            st.session_state["operations_data"][j] = st.number_input(Ops_labels, value=min, placeholder=Number_of_aircraft_sold)
            j=j+1
            Gross_Margin = st.session_state["operations_data"][j]
            st.session_state["operations_data"][j] = st.number_input(Ops_labels, value=min, placeholder=Gross_Margin)
            j=j+1
            Debt_to_Equity_ratio = st.session_state["operations_data"][j]
            st.session_state["operations_data"][j] = st.number_input(Ops_labels, value=min, placeholder=Debt_to_Equity_ratio)
            j=j+1
            MRO_services_Revenue = st.session_state["operations_data"][j]
            st.session_state["operations_data"][j] = st.number_input(Ops_labels, value=min, placeholder=MRO_services_Revenue)
            j=j+1
            Partnership_Revenue = st.session_state["operations_data"][j]
            st.session_state["operations_data"][j] = st.number_input(Ops_labels, value=min, placeholder=Partnership_Revenue)
            j=j+1
            Operating_Expenses = st.session_state["operations_data"][j]
            st.session_state["operations_data"][j] = st.number_input(Ops_labels, value=min, placeholder=Operating_Expenses)
            j=j+1
            Investor_Capital_Calls = st.session_state["operations_data"][j]
            st.session_state["operations_data"][j] = st.number_input(Ops_labels, value=min, placeholder=Investor_Capital_Calls)
