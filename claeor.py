...
def load_assumptions():
    assumptions = {}
    with open('https://github.com/Tokens-buy-Time/CLAEOR-Tool/blob/main/Assumptions.txt', 'r') as file:
...
def load_operations_data():
    operations_data = {}
    with open('https://github.com/Tokens-buy-Time/CLAEOR-Tool/blob/main/Operations-Data.txt', 'r') as file:
        lines = file.readlines()
