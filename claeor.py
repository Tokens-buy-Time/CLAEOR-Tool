...
def home_screen():
    ...
    st.write("""
        ...
        data. ⚠️ - Use the sidebar icons '>' & '<' to navigate through different sections of the tool. It is recommended that you select and review the "Instructions" menu option prior to using the App.
    """)
